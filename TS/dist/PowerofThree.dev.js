...
var PowerofTwo_1 = require("./PowerofTwo"); //----------------------------Step 1----------------------------//
// Key Points.
...
var isPowerOfThree = function isPowerOfThree(n) {
  console.log(parseFloat(PowerofTwo_1.LOG_LN(n, 3)));
  if (parseFloat(PowerofTwo_1.LOG_LN(n, 3).toFixed(20)) % 1 == 0) return true;
  return false;
};
