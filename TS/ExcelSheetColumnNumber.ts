...
// We assume our aim to give the best solution possible ( Optimal balance between time and space complexity and the best readability ) 

//----------------------------Step 4----------------------------//

// HADOOOOOOOOOOOOOOOOUKEN
